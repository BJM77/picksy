...
export const SEO_TOPICS: SEOTopic[] = [
    ...
    },
    {
        ...
        description: 'Discover rare and classic Air Jordan 4 Retro colorways. Verified authentic by Picksy, the premier Australian basketball marketplace.',
        category: 'Sneakers',
    ...
    },
    {
        ...
        description: 'The return of an icon. Secure your authenticated pair of Air Jordan 4 Military Blue sneakers today safely through Picksy.',
        category: 'Sneakers',
