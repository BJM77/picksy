...
export const SEO_GUIDES: Guide[] = [
    {
      ...
      <h2>Buying with Confidence on Picksy</h2>
      <p>At Picksy, we protect Australian buyers with our rigorous DealSafe escrow system, ensuring you never get burned on a high-value transaction.</p>
    `,
        coverImage: 'https://images.unsplash.com/photo-1597045566677-8cf032ed6634?q=80&w=2600&auto=format&fit=crop',
        date: '2024-03-15',
        author: 'Picksy Editorial Team',
    ...
    },
    {
      ...
      <p>The sports card market experienced a massive boom in 2020, and NBA cards led the charge. For Australian collectors, accessing premium cards has traditionally been difficult. Picksy changes that by providing a local, secure marketplace.</p>
    ...
    `,
        ...
        date: '2024-04-02',
        author: 'Alex (Picksy Cards Expert)',
