            ...
            html: `
                <div style="font-family: sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border: 1px solid #eee; border-radius: 10px;">
                    ...
                    <div style="margin: 30px 0;">
                        <a href="https://picksy.au/profile/orders" style="background-color: #f26c0d; color: white; padding: 12px 25px; text-decoration: none; border-radius: 5px; font-weight: bold;">Go to My Orders</a>
                    </div>
                    ...
                    <p style="font-size: 10px; color: #999;">Picksy Marketplace Australia</p>
                </div>
            `
        });
...
export async function triggerReviewNudge(productId: string, buyerUid: string) {
    ...
    try {
        ...
        const siteUrl = process.env.NEXT_PUBLIC_SITE_URL || 'https://picksy.au';
