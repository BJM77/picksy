...
export default function MultiCoinPage() {
    ...
    const takePicture = () => {
        ...
        context.drawImage(video, sourceX, sourceY, sourceWidth, sourceHeight, 0, 0, 600, 600);
    ...
    const handleSave = async () => {
        ...
        try {
            ...
            if (result.success) {
                toast({ title: "Coin Listed Successfully!" });
                resetAndNext();
            } else {
        ...
        <div className="fixed inset-0 h-[100dvh] flex flex-col bg-background text-foreground overflow-hidden">
            ...
            <div className="flex items-center justify-between px-4 py-2 border-b">
                ...
                <div className="flex gap-1">
                    {[1, 2, 3, 4, 5].map(i => (
                        <div key={i} className={cn("size-1.5 rounded-full", capturedImages.length >= i ? "bg-amber-500" : "bg-neutral-200 dark:bg-neutral-800")} />
                    ))}
                </div>
            </div>
            ...
            <div className="relative flex-1 bg-black overflow-hidden m-2 rounded-2xl shadow-inner group">
                ...
                <div className="absolute bottom-6 left-0 right-0 flex justify-center items-center gap-8">
                    ...
                    >
                        <div className="size-16 rounded-full bg-amber-500 shadow-xl" />
                    </button>
            ...
            <div className="p-4 bg-background border-t flex flex-col gap-3">
                <div className="relative">
                    <Input
                        placeholder="Coin Title (AI auto-fills...)"
                        value={title}
                    ...
                    <button
                        ...
                        className={cn(
                            ...
                            isAnalyzing ? "text-amber-500 animate-pulse" : "text-muted-foreground hover:text-amber-500"
                        )}
                    >
                ...
                <Button
                    ...
                    className="h-14 rounded-xl text-lg font-black bg-amber-600 hover:bg-amber-500 text-white shadow-lg shadow-amber-500/10"
                >
